...
const products = [
  {
    ...
    price: "$285",
    image: "/assets/iron/waxed-canvas-chore-coat.png",
  },
  {
    name: "selvedge denim",
    price: "$195",
  ...
  },
  {
    ...
    price: "$85",
    image: "/assets/iron/iron-oak-gloves.png",
  },
  {
    name: "moto boot",
    price: "$340",
...
const journalEntries = [
  {
    ...
    image: "/assets/iron/iron-oak-coast.png",
  },
  {
...
function MockIronAndOak() {
  return (
    <div
      className="min-h-[2660px] overflow-hidden bg-[#e8dcc4] text-[#161717]"
      ...
      <main className="pt-10">
        <section className="mb-28 px-5 md:px-16">
          <GrainImage
            ...
            src="/assets/iron/iron-oak-hero.png"
          />
          <div className="mx-auto mt-12 max-w-7xl">
            <div className="max-w-2xl">
              <h2
                ...
                style={{
                  fontFamily: "'Bricolage Grotesque', Chivo, sans-serif",
                }}
              >
                iron & oak
              </h2>
              <p className="mb-8 text-lg font-light italic leading-8 text-[#444748]">
                Made for the ride. Built to outlast it.
              </p>
            ...
            {products.map((product) => (
              <article key={product.name} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col items-start">
                  <span className="text-base lowercase text-[#161717]">
                    {product.name}
                  </span>
                  <span className="text-base lowercase text-[#444748]/75">
                    {product.price}
                  </span>
                </div>
              </article>
        ...
        <section className="mb-28">
          ...
          <div
            className="flex gap-6 overflow-x-auto px-5 pb-8 md:px-16"
            style={{ scrollbarWidth: "none" }}
          >
            {journalEntries.map((entry, index) => (
              <article
                key={entry.title}
                className={`${index === 0 ? "w-[520px]" : "w-[420px]"} max-w-[78vw] flex-none`}
              >
                <GrainImage
                  alt={entry.title}
                  ...
                  src={entry.image}
                />
                <p className="mt-4 text-sm lowercase italic text-[#444748]">
                  {entry.title}
                </p>
              </article>
            ))}
        ...
        <section className="relative mb-28 h-[520px] overflow-hidden">
          <GrainImage
            ...
            src="/assets/iron/iron-oak-gloves.png"
          />
        ...
        <section className="bg-[#ebe7e7]/35 px-5 py-24 md:px-16">
          <div className="max-w-xl">
            ...
            <p className="mb-8 text-base lowercase leading-7 text-[#444748]">
              updates on small batch releases, stories from the road, and garage
              sessions.
            </p>
            <form className="flex items-center gap-4 border-b border-[#161717] pb-2">
              ...
              <button
                ...
                className="text-[#161717] transition-colors hover:text-[#75593e]"
                type="button"
              >
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start gap-8">
          ...
          <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-3">
            <div className="flex flex-col gap-2">
              {["instagram", "pinterest", "newsletter signup"].map((item) => (
                <span key={item} className="lowercase text-[#444748]">
                  {item}
                </span>
              ))}
            </div>
            <div className="flex flex-col gap-2">
              {["shipping & returns", "size guide", "privacy policy"].map(
                (item) => (
                  <span key={item} className="lowercase text-[#444748]">
                    {item}
                  </span>
          ...
          <div className="w-full border-t border-[#c4c7c7]/70 pt-8">
            <p className="lowercase text-[#444748]">
              © 2024 iron & oak menswear. small batch quality.
            </p>
          </div>
        </div>
      </footer>
        ...
        <div className="mb-16 grid grid-cols-1 gap-16 lg:grid-cols-3">
          <div className="lg:col-span-2">
            ...
            <p className="max-w-2xl font-serif text-lg leading-relaxed text-muted-foreground">
              A small-batch menswear label needed a storefront that felt
              tactile, lived-in, and road-tested. We built an analog-inspired
              retail experience around waxed canvas, moto culture, product
              texture, and journal-driven storytelling.
            </p>
          </div>
